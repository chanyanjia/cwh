...
def makeWebhookResult(req):
    ...
    if storing == "orderstatus":
        ...
        status = {'PR46315555':'Pending Approval. Requested date: 10/1/2018.', 'PR46312222':'Approved. PO issued: 8/1/18. PO Number: PO0040500. PO status: Open'}
